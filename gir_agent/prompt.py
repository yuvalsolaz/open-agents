...
ORCHESTRATOR_PROMPT = """
**Role:**
- You are the highly-capable manager of a geographic intelligent team.
...
2.  **Augment Locations data:** Your second action is to delegate to your `google_search_agent`. Instruct it to find more meta data on each location entity.
...
5.  **Synthesize and Create the Final Report:**
    ...
    **only select locations with a good match**
